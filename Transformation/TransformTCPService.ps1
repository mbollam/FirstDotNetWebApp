...
Update-Configuration -TransformFileName "Nalco.WPS.TcpHostService.exe.config" "Nalco.WPS.TcpHostService.transform.xml"
Write-Output "Nalco.WPS.TcpHostService.exe.config transformation success!"