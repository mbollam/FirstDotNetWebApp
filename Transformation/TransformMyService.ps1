...
Update-Configuration -TransformFileName "Ecolab.Conduit.MyServiceSyncService.exe.config" "Ecolab.Conduit.MyServiceSyncService.transform.xml"
Write-Output "Ecolab.Conduit.MyServiceSyncService.exe.config transformation success!"